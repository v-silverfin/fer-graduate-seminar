...
Dobiveni latentni vektor sažeta je reprezentacija podataka za učenje no iako je koristan za pohranu, nije iskoristiv za generiranje novih, izmjenjenih podataka. 

Da bi to omogućili, uvodimo ograničenje na mrežu da latentni vektor mora ličiti na gausovu distribuciju iz koje je moguće uzorkovati podatke. Takva mreža naziva se varijacijski autoenkoder (VAE), a cilj joj je odvojeno naučiti parametre normalne distribucije te parametre standardne devijacije.
...
\begin{figure}[H]
    ...
    \caption{ TODO \cite{liu2017unsupervised}}
...
\begin{figure}[H]
    ...
    \caption{ TODO \cite{huang2018multimodal}}
